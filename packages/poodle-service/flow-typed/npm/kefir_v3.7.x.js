...
declare module 'kefir' {
  declare type Event<V, E> =
    | { type: 'value', value: V }
    | { type: 'error', value: E }
    | { type: 'end', value: void }

  declare type Emitter<V, E> = {
  ...
  declare type Observer<V, E> = {
    +value?: (value: V) => void,
    +error?: (err: E) => void,
    +end?: () => void
  }

  declare interface ESObserver<-V, -E> {
    start?: Function,
    next?: (value: V) => any,
    error?: (error: E) => any,
    complete?: () => any
 ...
 */
  ...
  declare class Observable<+V, +E = *> {
    ...
    withHandler<V2, E2>(
      handler: (emitter: Emitter<V2, E2>, event: Event<V, E>) => void
    ): Observable<V2, E2>,

    combine<V2, E2>(
      otherObs: Observable<V2, E2>,
      $?: empty
    ): Observable<[V, V2], E | E2>,
    combine<V2, V3, E2>(
      otherObs: Observable<V2, E2>,
      combinator: (v: V, v2: V2) => V3
    ): Observable<V3, E | E2>,
    combine<V2, V3, E2, E3>(
      otherObs: Observable<V2, E2>,
    ...
    flatMap<V2, E2>(
      transform: (value: V) => Observable<V2, E2>
    ): Observable<V2, E | E2>,
    flatMapLatest<V2, E2>(
      transform: (value: V) => Observable<V2, E2>
    ): Observable<V2, E | E2>,
    ...
    flatMapConcurLimit<V2, E2>(
      transform: (value: V) => Observable<V2, E2>,
      limit: number
    ): Observable<V2, E | E2>,
    flatMapErrors<V2, E2>(
      transform: (error: E) => Observable<V2, E2>
    ): Observable<V | V2, E2>,
    ...
    sampledBy<V2, V3>(
      otherObs: Observable<V2, any>,
      combinator: (obsValue: V, otherObsValue: V2) => V3
    ): Observable<V3, E>,
  ...
  // input tuple.
  declare type $observedValuesTuple<Obss> = $TupleMap<
    Obss,
    <V, E>(obs: Observable<V, E>) => V
  >
  ...
  declare type $observedValuesObject<Obss> = $ObjMap<
    Obss,
    <V, E>(obs: Observable<V, E>) => V
  >

  declare var staticLand: {
    Observable: {
      ap<A, B, E1, E2>(
        obsF: Observable<(x: A) => B, E1>,
        obsV: Observable<A, E2>
      ): Observable<B, E1 | E2>,
      bimap<V1, E1, V2, E2>(
        fnE: (x: E1) => E2,
        fnV: (x: V1) => V2,
        obs: Observable<V1, E1>
      ): Observable<V2, E2>,
      chain<V, V2, E, E2>(
        cb: (value: V) => Observable<V2, E2>,
        s: Observable<V, E>
      ): Observable<V2, E | E2>,
      concat<V1, E1, V2, E2>(
        obs1: Observable<V1, E1>,
        obs2: Observable<V2, E2>
      ): Observable<V1 | V2, E1 | E2>,
      empty(): Observable<*, *>,
      map<V, V2, E>(
        cb: (value: V) => V2,
        s: Observable<V, E>
  ...
  declare function never(): Observable<empty, empty>
  declare function later<V>(delay: number, value: V): Observable<V, empty>
  declare function interval<V>(interval: number, value: V): Observable<V, empty>
  declare function sequentially<V>(
    interval: number,
    values: V[]
  ): Observable<V, empty>
  declare function fromPoll<V>(
    interval: number,
    f: () => V
  ): Observable<V, empty>
  declare function withInterval<V, E>(
    interval: number,
    f: (emitter: Emitter<V, E>) => void
  ): Observable<V, E>
  declare function fromCallback<V>(
    f: (cb: (value: V) => void) => void
  ): Observable<V, empty>
  declare function fromNodeCallback<V, E>(
    f: (cb: (err: E, value: ?V) => void) => void
  ): Observable<V, E>
  declare function fromEvents<V, E>(
    target: EventTarget | EventEmitter, // `EventTarget` comes from Flow's built-in dom types
    eventName: string,
    transformer?: (...args: any[]) => V
  ): Observable<V, E>
  declare function stream<V, E>(
    subscribe: (emitter: Emitter<V, E>) => ?() => void
  ): Observable<V, E>

  declare function constant<V>(value: V): Property<V, empty>
  declare function constantError<E>(err: E): Property<empty, E>

  declare function fromPromise<V, E>(promise: Promise<V>): Property<V, E>
  declare function fromESObservable<V, E>(
    observable: ESObservable<V, E>
  ): Observable<V, E>

  declare var combine: (<E, Obss: Observable<any, E>[]>( // array of observables
    obss: Obss,
    $?: empty
  ) => Observable<$observedValuesTuple<Obss>, E>) &
    // array of observables, combinator
    (<V, E>(
      obss: Observable<any, E>[],
      combinator: (...args: any[]) => V
    ) => Observable<V, E>) &
    // array of observables, array of passive observables
    (<V, V2, E, E2>(
      obss: Observable<V, E>[],
      passiveObss: Observable<V2, E2>[],
      $?: empty
    ) => Observable<(V | V2)[], E | E2>) &
    // array of observables, array of passive observables, combinator
    (<V, E, E2>(
      obss: Observable<any, E>[],
      passiveObss: Observable<any, E2>[],
      combinator: (...args: any[]) => V
    ) => Observable<V, E | E2>) &
    ...
    (<
      E,
      E2,
      Obss: { [key: string]: Observable<any, E> },
      PassiveObss: { [key: string]: Observable<any, E2> }
    >(
      obss: Obss,
    ...
    >(
      ...
      passiveObss: PassiveObss,
      combinator: (
        vs: $observedValuesObject<Obss> & $observedValuesObject<PassiveObss>
      ) => V
    ) => Observable<V, E | E2>)

  declare var zip: (<E, Obss: Observable<any, E>[]>(
    obss: Obss,
    $?: empty
  ) => Observable<$observedValuesTuple<Obss>, E>) &
    (<V, V2, E>(
      obss: Observable<any, E>[],
      combinator: (...args: any[]) => V2
    ) => Observable<V2, E>)

  declare function merge<V, E>(obss: Observable<V, E>[]): Observable<V, E>
  declare function concat<V, E>(obss: Observable<V, E>[]): Observable<V, E>

  declare function pool(): Pool<*, *>
  declare function repeat<V, E>(
    fn: (i: number) => ?Observable<V, E>
  ): Observable<V, E>
}
